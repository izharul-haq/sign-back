from .funcs import shift_right, sigma0, sigma1, s0, s1, choose, majority
...
def sha256(message: bytearray) -> bytearray:
    ...
    for message_block in blocks:
        ...
        for t in range(16, 64):
            ...
            term4 = sigma1(int.from_bytes(message_schedule[t-2], 'big'))
        ...
        for t in range(64):
            t1 = ((h + s1(e) + choose(e, f, g) + K[t] +
                   int.from_bytes(message_schedule[t], 'big')) % (2**32))
            t2 = (s0(a) + majority(a, b, c)) % (2**32)
